...
//        _playPauseButton.titleLabel.font = [UIFont systemFontOfSize:12];
     //   _playPauseButton.backgroundColor = [UIColor redColor];
        [_playPauseButton setImage:[self imagesNamedFromCustomBundle:@"play.png"] forState:UIControlStateNormal];
        [_playPauseButton setImage:[self imagesNamedFromCustomBundle:@"pause.png"] forState:UIControlStateSelected];
...
#pragma clang diagnostic pop
        ...
        NSString* defaultBtnText = kUexQCloudTitle;
...
#pragma clang diagnostic pop
        ...
        [_fullScreenButton setImage:[self imagesNamedFromCustomBundle:@"full.png"] forState:UIControlStateNormal];
        [_fullScreenButton setImage:[self imagesNamedFromCustomBundle:@"notfull.png"] forState:UIControlStateSelected];
...
{
    NSBundle *bundle = [EUtility bundleForPlugin:@"uexQcloudAV"];
